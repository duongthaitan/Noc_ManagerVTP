  ...
  reader.onload = function (e) {
    setTimeout(() => {
      try {
        ...
        modeCounts.do9   = raw.filter(r => String(r['LOAI_CANH_BAO'] || '').trim() === 'DO_9').length;
        modeCounts.do8   = raw.filter(r => String(r['LOAI_CANH_BAO'] || '').trim() === 'DO_8').length;
        modeCounts.do7   = raw.filter(r => String(r['LOAI_CANH_BAO'] || '').trim() === 'DO_7').length;
